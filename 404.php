        ...
        <section class="error-404 not-found">
            ...
            <div class="page-content">
                ...
                <div class="widget widget_categories">
                    <h2 class="widget-title"><?php esc_html_e('Most Used Categories', 'THEME_TEXTDOMAIN'); ?></h2>
                    <ul>
                        <?php
                        wp_list_categories(
                            array(
                ...
                $_s_archive_content = '<p>' . sprintf(esc_html__('Try looking in the monthly archives. %1$s', 'THEME_TEXTDOMAIN'), convert_smilies(':)')) . '</p>';
