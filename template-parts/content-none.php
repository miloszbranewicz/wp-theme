<section class="no-results not-found">
    <header class="page-header">
        <h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'THEME_TEXTDOMAIN' ); ?></h1>
    </header><!-- .page-header -->
        ...
        if ( is_home() && current_user_can( 'publish_posts' ) ) :
            ...
            printf(
                ...
                /* translators: 1: link to WP admin new post page. */
                    __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'THEME_TEXTDOMAIN' ),
                    array(
                        'a' => array(
                            'href' => array(),
                        ),
